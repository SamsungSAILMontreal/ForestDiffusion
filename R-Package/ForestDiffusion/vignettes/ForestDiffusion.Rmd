...
forest_model_uncond = ForestDiffusion(Xy, n_t=50, duplicate_K=50, flow=TRUE)
...
forest_model = ForestDiffusion(X, label_y=y, name_y='Species', n_t=50, duplicate_K=50, flow=TRUE)
...
forest_model_vp = ForestDiffusion(Xy, n_t=50, duplicate_K=50, flow=FALSE)
