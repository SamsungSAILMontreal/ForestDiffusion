...
data = read.csv("C:/Users/Alexia-Mini/Sync/Ubuntu_ML/projects/Tabular_Flow_Matching/Results/Results_tabular - generation.csv")
data = read.csv("C:/Users/alexi/Sync/Ubuntu_ML/projects/Tabular_Flow_Matching/Results/Results_tabular - generation.csv")
...
rownames(data_summary_t) = c("GaussianCopula", "TVAE", "CTGAN", "CTAB-GAN+", "STaSy", "TabDDPM", "Forest-VP", "Forest-Flow", "Oracle")
rownames(data_summary_rank_t) = c("GaussianCopula", "TVAE", "CTGAN", "CTAB-GAN+", "STaSy", "TabDDPM", "Forest-VP", "Forest-Flow")
